...
def plot_clusters(data_url, clustering_func, num_clusters, num_iterations = 1):
    """
    ...
    if clustering_func == 'sequential':
        cluster_list = sequential_clustering(singleton_list, num_clusters)	
        print "Displaying", len(cluster_list), "sequential clusters"
    elif clustering_func == 'hierarchical':
        cluster_list = alg_project3_solution.hierarchical_clustering(singleton_list, num_clusters)
        print "Displaying", len(cluster_list), "hierarchical clusters"
    elif clustering_func == 'k-means':
        cluster_list = alg_project3_solution.kmeans_clustering(singleton_list, num_clusters, num_iterations)	
        print "Displaying", len(cluster_list), "k-means clusters"
    else:
        print 'Invalid clustering function'
        return
